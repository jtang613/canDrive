...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.showSendingTableCheckBox.setChecked(True)
        ...
        self.mainMessageTableWidget.horizontalHeader().setSortIndicatorShown(True)
        self.mainMessageTableWidget.verticalHeader().setSortIndicatorShown(False)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 382, 553))
        ...
        self.decodedMessagesTableWidget.horizontalHeader().setSortIndicatorShown(True)
        self.decodedMessagesTableWidget.verticalHeader().setSortIndicatorShown(True)
        ...
        self.idLabelDictTable.horizontalHeader().setSortIndicatorShown(True)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sendTxTableButton.sizePolicy().hasHeightForWidth())
        self.sendTxTableButton.setSizePolicy(sizePolicy)
        self.sendTxTableButton.setMinimumSize(QtCore.QSize(0, 35))
        ...
        self.showOnlyIdsCheckBox.clicked['bool'].connect(self.showOnlyIdsLineEdit.setEnabled) # type: ignore
        self.hideIdsCheckBox.clicked['bool'].connect(self.hideIdsLineEdit.setEnabled) # type: ignore
        self.checkBox_6.clicked['bool'].connect(self.clearLabelDictButton.setEnabled) # type: ignore
        self.hideOldPacketsCheckBox.clicked['bool'].connect(self.hideOldPeriod.setEnabled) # type: ignore
        self.showSendingTableCheckBox.clicked['bool'].connect(self.sendingGroupBox.hide) # type: ignore
        self.hideControlsButton.pressed.connect(self.groupBox_4.hide) # type: ignore
        self.hideControlsButton.pressed.connect(self.groupBox_5.hide) # type: ignore
        self.hideControlsButton.pressed.connect(self.groupBox.hide) # type: ignore
        self.hideControlsButton.pressed.connect(self.line_4.hide) # type: ignore
        self.hideControlsButton.pressed.connect(self.showControlsButton.show) # type: ignore
        self.showControlsButton.pressed.connect(self.showControlsButton.hide) # type: ignore
        self.showControlsButton.pressed.connect(self.line_4.show) # type: ignore
        self.showControlsButton.pressed.connect(self.groupBox_4.show) # type: ignore
        self.showControlsButton.pressed.connect(self.groupBox_5.show) # type: ignore
        self.showControlsButton.pressed.connect(self.groupBox.show) # type: ignore
        self.hideIdsCheckBox.clicked['bool'].connect(self.hideAllPacketsButton.setEnabled) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mainMessageTableWidget.setSortingEnabled(True)
